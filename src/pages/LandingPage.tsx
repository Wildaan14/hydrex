...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#f8fafc] font-sans selection:bg-emerald-500/30 overflow-x-hidden text-slate-800" style={{ backgroundColor: "#f8fafc" }}>
      ...
      <section id="solution" className="py-24" style={{ backgroundColor: "#f1f5f9" }}>
      ...
      {/* ----------------- CONTACT SECTION ----------------- */}
      <section id="contact" className="py-24 relative" style={{ backgroundColor: "#0f172a" }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            ...
            <div className="rounded-[40px] p-10 md:p-14" style={{ backgroundColor: "#ffffff" }}>
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div>
                  ...
                  <input type="text" placeholder="Grup Konservasi Internasional" className="w-full rounded-2xl px-6 py-4 font-medium" style={{ backgroundColor: "#f8fafc", border: "1px solid #cbd5e1", color: "#0f172a" }} />
                </div>
                <div>
                  <label className="block text-sm font-bold uppercase mb-3" style={{ color: "#475569" }}>{current.contact.fEmail}</label>
                  <input type="email" placeholder="ceo@company.com" className="w-full rounded-2xl px-6 py-4 font-medium" style={{ backgroundColor: "#f8fafc", border: "1px solid #cbd5e1", color: "#0f172a" }} />
                </div>
                <div>
                  <label className="block text-sm font-bold uppercase mb-3" style={{ color: "#475569" }}>{current.contact.fMsg}</label>
                  <textarea rows={4} className="w-full rounded-2xl px-6 py-4 font-medium resize-none" style={{ backgroundColor: "#f8fafc", border: "1px solid #cbd5e1", color: "#0f172a" }}></textarea>
                </div>
                <button className="w-full font-black text-xl py-5 rounded-2xl transition-transform hover:-translate-y-1" style={{ backgroundColor: "#10b981", color: "#ffffff", boxShadow: "0 10px 25px -5px rgba(16, 185, 129, 0.4)" }}>
